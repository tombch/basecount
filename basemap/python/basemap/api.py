from .basemap import all_, query_, iquery_, parse_region_
...
def query(bam_path: str, region: str, mapping_quality: int = 0, base_quality: int = 0):
    return query_(bam_path, region, mapping_quality, base_quality)
...
def iquery(
    ...
    return iquery_(bam_path, bai_path, region, mapping_quality, base_quality)
